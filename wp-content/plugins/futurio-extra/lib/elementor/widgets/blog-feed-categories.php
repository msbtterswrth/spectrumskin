 ...
 * @since 1.0.0
 */
class Futurio_Extra_Blog_Feed_Categories extends Widget_Base {
    ...
    public function get_title() {
        return __('Post categories', 'futurio-extra');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::TEXT,
                    'default' => __('Categories:', 'futurio-extra'),
                    'placeholder' => __('Categories:', 'futurio-extra'),
                ]
        );
        $this->add_control(
                'icon',
        ...
        $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .futurio-elementor-categories .elementor-align-icon-right' => 'margin-left: {{SIZE}}{{UNIT}};',
                        '{{WRAPPER}} .futurio-elementor-categories .elementor-align-icon-left' => 'margin-right: {{SIZE}}{{UNIT}};',
                    ],
                ]
        );
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .futurio-elementor-categories' => 'text-align: {{VALUE}};',
                    ],
                ]
        );
        ...
        $this->add_responsive_control(
                'title_color',
                [
                    'label' => __('Category Color', 'futurio-extra'),
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
        ...
        $this->add_control(
                ...
                [
                    ...
                    'separator' => 'before',
                    'selectors' => [
                        '{{WRAPPER}} .futurio-elementor-categories' => 'color: {{VALUE}}',
                    ],
                ]
        );
        $this->add_group_control(
                ...
                [
                    ...
                    'placeholder' => '1px',
                    'default' => '1px',
                    'selector' => '{{WRAPPER}} .futurio-elementor-categories a',
                    'separator' => 'before',
                ]
        );
        ...
        $this->add_control(
                ...
                [
                    ...
                    'size_units' => ['px', '%'],
                    'selectors' => [
                        '{{WRAPPER}} .futurio-elementor-categories a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
        );
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => ['px', 'em', '%'],
                    'selectors' => [
                        '{{WRAPPER}} .futurio-elementor-categories a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
        );
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => ['px', 'em', '%'],
                    'selectors' => [
                        '{{WRAPPER}} .futurio-elementor-categories a' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                    'separator' => 'before',
                ]
        );
    ...
    protected function render() {
        ...
        $this->add_render_attribute([
            'futurio-categories' => [
                'class' => 'futurio-elementor-categories',
            ],
            'futurio-categories-title' => [
        ...
        if (is_home() || is_archive() || is_search()) {
            ?>
            <div <?php echo $this->get_render_attribute_string('futurio-categories'); ?>>
                <div <?php echo $this->get_render_attribute_string('futurio-categories-title'); ?>>
