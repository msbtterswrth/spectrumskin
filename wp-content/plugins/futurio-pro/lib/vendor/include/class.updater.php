<?php
    ...
    class FUTURIO_SLT_CodeAutoUpdate
         {
    ...
    function FUTURIO_SLT_run_updater()
         {
         
             $wp_plugin_auto_update = new FUTURIO_SLT_CodeAutoUpdate(FUTURIO_SLT_APP_API_URL, 'futurio-pro', 'futurio-pro/futurio-pro.php');
    ...
    add_action( 'after_setup_theme', 'FUTURIO_SLT_run_updater' );
