    ...
    class FUTURIO_SLT_licence
        {
            ...
            function is_local_instance()
                {
                    return FALSE; 
                    $instance   =   trailingslashit(FUTURIO_SLT_INSTANCE);
                    if(
            ...
            function licence_deactivation_check()
                {
                    ...
                    if(isset($license_data['last_check']))
                        {
                            if(time() < ($license_data['last_check'] + 2592000))
                                {
                                    return;
                                }
                        }
                    ...
                    if(is_wp_error( $data ) || $data['response']['code'] != 200)
                        {
                        $license_data['last_check']   = absint(time()-1728000);    
