...
/* ------------------------------------ */
	function __construct() {
		parent::__construct( false, esc_html__( 'Alx Tabs', 'futurio-pro' ), array('description' => esc_html__('List posts, comments, and/or tags with or without tabs.', 'futurio-pro' ), 'classname' => 'widget_alx_tabs', 'customize_selective_refresh' => true ) );
	}
...
/* ------------------------------------ */
	private function _create_tabs($tabs,$count) {
		...
		$titles = array(
			'recent'	=> esc_html__('Recent Posts','futurio-pro'),
			'popular'	=> esc_html__('Popular Posts','futurio-pro'),
			'comments'	=> esc_html__('Recent Comments','futurio-pro'),
			'tags'		=> esc_html__('Tags','futurio-pro')
		);
		$icons = array(
		...
		$output = sprintf('<ul class="pro-tabs-nav group tab-count-%s">', $count);
		foreach ( $tabs as $tab ) {
			$output .= sprintf('<li class="pro-tab tab-%1$s"><a href="#tab-%2$s" title="%4$s"><i class="%3$s"></i><span>%4$s</span></a></li>',$tab, $tab . '-' . $this -> number, $icons[$tab], $titles[$tab]);
		}
		$output .= '</ul>';
		return $output;
	}
...
?>
	...
	<div class="pro-tabs-container">
		...
		<?php if($instance['recent_enable']) { // Recent posts enabled? ?>
			...
			<div id="tab-recent-<?php echo $this -> number ?>" class="pro-tab group <?php if($instance['recent_thumbs']) { echo 'thumbs-enabled'; } ?>">
				<?php while ($recent->have_posts()): $recent->the_post(); ?>
				<div class="pro-inner-item">
		...
		<?php if($instance['popular_enable']) { // Popular posts enabled? ?>
			...
			?>
			<div id="tab-popular-<?php echo $this -> number ?>" class="pro-tab group <?php if($instance['popular_thumbs']) { echo 'thumbs-enabled'; } ?>">
		...
		<?php if($instance['comments_enable']) { // Recent comments enabled? ?>
			...
			<div id="tab-comments-<?php echo $this -> number ?>" class="pro-tab group <?php if($instance['comments_avatars']) { echo 'avatars-enabled'; } ?>">
				...
				<div class="pro-inner-item">
						...
						<div class="tab-item-inner group">
							...
							<div class="tab-item-name"><?php echo esc_attr( $comment->comment_author ); ?> <?php esc_html_e('says:','futurio-pro'); ?></div>
		...
		<?php if($instance['tags_enable']) { // Tags enabled? ?>
			...
			<div id="tab-tags-<?php echo $this -> number ?>" class="pro-tab group">
				<div class="pro-inner-item">
					<?php wp_tag_cloud(); ?>
				</div>
			</div><!--/.pro-tab-->
...
?>
	...
	<div class="pro-options-tabs">
		...
		<h4><?php esc_html_e( 'Recent Posts', 'futurio-pro' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('recent_enable') ); ?>"><?php esc_html_e( 'Enable recent posts', 'futurio-pro' ); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('recent_thumbs') ); ?>"><?php esc_html_e( 'Show thumbnails', 'futurio-pro' ); ?></label>
		</p>
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("recent_num") ); ?>"><?php esc_html_e( 'Items to show', 'futurio-pro' ); ?></label>
		...
		<p>
			<label style="width: 100%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("recent_cat_id") ); ?>"><?php esc_html_e( 'Category:', 'futurio-pro' ); ?></label>
			<?php wp_dropdown_categories( array( 'name' => $this->get_field_name("recent_cat_id"), 'selected' => $instance["recent_cat_id"], 'show_option_all' => esc_html__('All','futurio-pro'), 'show_count' => true ) ); ?>
		</p>

		<hr>
		<h4><?php esc_html_e( 'Most Popular', 'futurio-pro' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('popular_enable') ); ?>"><?php esc_html_e( 'Enable most popular posts', 'futurio-pro' ); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('popular_thumbs') ); ?>"><?php esc_html_e( 'Show thumbnails', 'futurio-pro' ); ?></label>
		</p>
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("popular_num") ); ?>"><?php esc_html_e( 'Items to show', 'futurio-pro' ); ?></label>
		...
		<p>
			<label style="width: 100%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("popular_cat_id") ); ?>"><?php esc_html_e( 'Category:', 'futurio-pro' ); ?></label>
			<?php wp_dropdown_categories( array( 'name' => $this->get_field_name("popular_cat_id"), 'selected' => $instance["popular_cat_id"], 'show_option_all' => esc_html__('All','futurio-pro'), 'show_count' => true ) ); ?>
		</p>
		<p style="padding-top: 0.3em;">
			<label style="width: 100%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("popular_time") ); ?>"><?php esc_html_e( 'Post with most comments from:', 'futurio-pro' ); ?></label>
			<select style="width: 100%;" id="<?php echo esc_attr( $this->get_field_id("popular_time") ); ?>" name="<?php echo esc_attr( $this->get_field_name("popular_time") ); ?>">
			  <option value="0"<?php selected( $instance["popular_time"], "0" ); ?>><?php esc_html_e( 'All time', 'futurio-pro' ); ?></option>
			  <option value="1 year ago"<?php selected( $instance["popular_time"], "1 year ago" ); ?>><?php esc_html_e( 'This year', 'futurio-pro' ); ?></option>
			  <option value="1 month ago"<?php selected( $instance["popular_time"], "1 month ago" ); ?>><?php esc_html_e( 'This month', 'futurio-pro' ); ?></option>
			  <option value="1 week ago"<?php selected( $instance["popular_time"], "1 week ago" ); ?>><?php esc_html_e( 'This week', 'futurio-pro' ); ?></option>
			  <option value="1 day ago"<?php selected( $instance["popular_time"], "1 day ago" ); ?>><?php esc_html_e( 'Past 24 hours', 'futurio-pro' ); ?></option>
			</select>
		</p>

		<hr>
		<h4><?php esc_html_e( 'Recent Comments', 'futurio-pro' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('comments_enable') ); ?>"><?php esc_html_e( 'Enable recent comments', 'futurio-pro' ); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('comments_avatars') ); ?>"><?php esc_html_e( 'Show avatars', 'futurio-pro' ); ?></label>
		</p>
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("comments_num") ); ?>"><?php esc_html_e( 'Items to show', 'futurio-pro' ); ?></label>
		...
		<hr>
		<h4><?php esc_html_e( 'Tags', 'futurio-pro' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('tags_enable') ); ?>"><?php esc_html_e( 'Enable tags', 'futurio-pro' ); ?></label>
		</p>

		<hr>
		<h4><?php esc_html_e( 'Tab Order', 'futurio-pro' ); ?></h4>

		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("order_recent") ); ?>"><?php esc_html_e( 'Recent posts', 'futurio-pro' ); ?></label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("order_popular") ); ?>"><?php esc_html_e( 'Most popular', 'futurio-pro' ); ?></label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("order_comments") ); ?>"><?php esc_html_e( 'Recent comments', 'futurio-pro' ); ?></label>
		...
		<p>
			<label style="width: 55%; display: inline-block;" for="<?php echo esc_attr( $this->get_field_id("order_tags") ); ?>"><?php esc_html_e( 'Tags', 'futurio-pro' ); ?></label>
		...
		<hr>
		<h4><?php esc_html_e( 'Tab Info', 'futurio-pro' ); ?></h4>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('tabs_category') ); ?>"><?php esc_html_e( 'Show categories', 'futurio-pro' ); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id('tabs_date') ); ?>"><?php esc_html_e( 'Show dates', 'futurio-pro' ); ?></label>
		</p>
